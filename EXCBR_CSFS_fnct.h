...
const char *CS_FNCT_DESC[] ={	"returns the number of char elt being vowel",
				"Returns the number of char elt being consonant",
				...
				"Search function returning the position of the first occurence of a pattern",
};
